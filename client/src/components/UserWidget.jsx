...
const UserWidget = ({ userId, picturePath }) => {
  ...
  return (
    <div
      className={`w-full px-[1.5rem] pt-[1.5rem] pb-[1rem] rounded-lg ${
    ...
    >
      {loading ? (
        ...
        <>
          ...
          {/* SECOND ROW */}
          <div
            className={`py-2 flex w-full justify-center flex-col  ${textPrimary}`}
          >
          ...
          <div className="py-4">
            <p className={`text-md font-bold mb-4 ${textPrimary}`}>
              {"Social Profiles"}
            </p>
